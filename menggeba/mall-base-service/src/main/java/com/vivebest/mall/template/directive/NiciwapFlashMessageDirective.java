 ...
 * @version 3.0
 */
@Component("niciwapFlashMessageDirective")
public class NiciwapFlashMessageDirective extends BaseDirective {

	/** "瞬时消息"属性名称 */
	public static final String FLASH_MESSAGE_ATTRIBUTE_NAME = NiciwapFlashMessageDirective.class.getName() + ".FLASH_MESSAGE";
		...
		if (requestAttributes != null) {
			...
			if (body != null) {
				...
				if (message != null) {
					...
					out.write("dialog(\"" + message.getType() + "\", \"" + message.getContent() + "\");");
				}
			}
		}
	}
