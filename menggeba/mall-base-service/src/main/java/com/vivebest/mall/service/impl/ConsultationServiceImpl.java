...
import com.vivebest.mall.dao.ConsultationDao;
import com.vivebest.mall.entity.Consultation;
import com.vivebest.mall.entity.Member;
import com.vivebest.mall.entity.Product;
import com.vivebest.mall.service.ConsultationService;
...
public class ConsultationServiceImpl extends BaseServiceImpl<Consultation, Long> implements ConsultationService {
	...
	@Transactional(readOnly = true)
	public Page<Consultation> findPage(Member member, Date beginDate, Date endDate, Product product, Boolean isShow, Pageable pageable) {
		return consultationDao.findPage(member, beginDate, endDate, product, isShow, pageable);
	}
