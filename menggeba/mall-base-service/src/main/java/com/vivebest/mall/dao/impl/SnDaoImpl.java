...
public class SnDaoImpl implements SnDao, InitializingBean {
	...
	private HiloOptimizer changesHiloOptimizer;
	...
	@Value("${sn.changes.prefix}")
	private String changesPrefix;
	@Value("${sn.changes.maxLo}")
	private int changesMaxLo;
	...
	public void afterPropertiesSet() throws Exception {
	    ...
	    changesHiloOptimizer=new HiloOptimizer(Type.changes, changesPrefix, changesMaxLo);
	    memberHiloOptimizer=new HiloOptimizer(Type.member, memberPrefix, memberMaxLo);
	}
	...
	public String generate(Type type) {
		...
		}else if(type == Type.changes){
			return changesHiloOptimizer.generate();
