 ...
 * @version 3.0
 */
public class WapMemberInterceptor extends HandlerInterceptorAdapter {
	...
	/** 默认登录URL */
	private static final String DEFAULT_LOGIN_URL = "/wap/login.do";
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		if (principal != null) {
			...
			if (requestType != null && requestType.equalsIgnoreCase("XMLHttpRequest")) {
				response.addHeader("loginStatus", "wapAccessDenied");
