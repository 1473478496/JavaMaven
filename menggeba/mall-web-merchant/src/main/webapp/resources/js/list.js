...
$().ready( function() {
	...
	var $secKillDateSelect = $("#secKillDateSelect");
	var $secKillDateOption = $("#secKillDateOption a");	
	...
	$deleteButton.click( function() {
		...
		var customUrl = "delete.jhtml";
		if($deleteButton.attr("deleteCustom")){
			customUrl = "deleteCustom.jhtml";
		}
	...
	// 秒杀时间点选项
	$secKillDateSelect.mouseover( function() {
		var $this = $(this);
		var offset = $this.offset();
		var $menuWrap = $this.closest("div.menuWrap");
		var $popupMenu = $menuWrap.children("div.popupMenu");
	...
	// 秒杀时间点
	$secKillDateOption.click( function() {
		var $this = $(this);
		$timePoint.val($this.attr("val"));
		$pageNumber.val("1");
		$listForm.submit();
		return false;
	});
	...
	$listForm.submit(function() {
		window.location.href="${base}/orderItem/list.do?pageNumber=10";
	...
	$exportButton.click( function() {
		var url = 'exportData.do?orderStatus='+$('#orderStatus').val()+'&paymentStaatus='+$('#paymentStatus').val()+'&shippingStatus='+$('#shippingStatus').val()+'&hasExpired='+$('#hasExpired').val()+'&searchProperty='+$searchProperty.val()+'&searchValue='+$searchValue.val()+'&bDate='+$('#beginDate').val()+'&eDate='+$('#endDate').val();
