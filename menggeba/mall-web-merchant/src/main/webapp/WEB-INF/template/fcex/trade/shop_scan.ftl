  ...
  <div class="wrap">
    <div class="container-setting fix">
      ...
      <div class="container-middle">
          ...
          <div class="shop-info">
            <div class="shop-logo"><img src="${base}/${tradeAdmin.trade.logo_url}" alt="" class="logo"></div>
          ...
          <div class="shop-setting">
            ...
            <div>
              <div class="income-view zl-s">
                <h4>收入总览</h4>
                <div>
                  <p>今日订单收入 : <span>524555</span>元</p>
                  <p>总订单收入 : <span>524555</span>元</p>
                </div>
              </div>
