...
<%@page import="com.vivebest.mall.core.common.Setting"%>
<%@page import="com.vivebest.mall.core.util.SettingUtils"%>
<%@page import="com.vivebest.mall.core.util.SpringUtils"%>
<%@page import="com.vivebest.mall.core.common.Setting.CaptchaType"%>
<%@page import="com.vivebest.mall.core.common.Setting.AccountLockType"%>
<%@page import="com.vivebest.mall.core.service.RSAService"%>
...
%>
<title><%=SpringUtils.getMessage("admin.login.title")%> - Powered By 萌哥吧</title>
<meta http-equiv="expires" content="0" />
<meta http-equiv="Pragma" content="no-cache" />
<meta http-equiv="Cache-Control" content="no-cache" />
<meta name="author" content="萌哥吧 Team" />
<meta name="copyright" content="萌哥吧" />
...
<%} else {%>
<title>提示信息 - Powered By 萌哥吧</title>
<meta http-equiv="expires" content="0" />
<meta http-equiv="Pragma" content="no-cache" />
<meta http-equiv="Cache-Control" content="no-cache" />
<meta name="author" content="萌哥吧 Team" />
...
<body>
		<div class="login">
			<form id="loginForm" action="login.jsp" method="post">
				...
				<table>
					<tr>
						<td width="190" rowspan="2" align="center" valign="bottom">
							<img src="<%=setting.getLogo()%>" alt="萌哥吧" />
						</td>
						<th>
				...
				<div class="powered">COPYRIGHT © 2005-<%=year%> www.mgb.cn ALL RIGHTS RESERVED.</div>				
			</form>
		</div>	
</body>
</html>