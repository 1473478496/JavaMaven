...
$().ready( function() {
	...
	$exportButton.click( function() {
		var url = 'exportData.jhtml?orderStatus='+$('#orderStatus').val()+'&paymentStaatus='+$('#paymentStatus').val()+'&shippingStatus='+$('#shippingStatus').val()+'&hasExpired='+$('#hasExpired').val()+'&searchProperty='+$searchProperty.val()+'&searchValue='+$searchValue.val()+'&bDate='+$('#beginDate').val()+'&eDate='+$('#endDate').val();
