...
<title>${message("admin.coupon.edit")} - Powered By www.mgb.cn</title>
...
$().ready(function() {
	...
	var $deleteProduct = $("a.deleteProduct");
		...
		var productIds = [#if coupon.products?has_content][[#list coupon.products as product]${product.id}[#if product_has_next], [/#if][/#list]][#else]new Array()[/#if];
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<div class="tabContent">
				   ...
				   <tr class="productCategory">
					...
					<td>
						...
						[#list productCategoryTree as productCategory]
							<option value="${productCategory.id}"[#if coupon.productCategories?seq_contains(productCategory)] selected="selected"[/#if]>
				...
				<!--<tr class="brand">
					...
					<td>
						[#list brands as brand]
							<label>
								<input type="checkbox" name="brandIds" value="${brand.id}"[#if coupon.brands?seq_contains(brand)] checked="checked"[/#if] />${brand.name}
							</label>
						[/#list]
					</td>
				</tr>-->
			  ...
			  <!--<tr>
				...
				<tr>
					...
					<td>
					    ...
					    <label>
							<input type="checkbox" id="isMarketbelong" name="isMarketbelong" value="true"[#if coupon.isMarketbelong] checked="checked"[/#if] />营销人员专属
				...
				<tr>
					...
					<td>
						<input type="text" id="point" name="point" class="text" value="${coupon.limtNums}" />  【0,表示不做限制】
					</td>
				</tr>
			...
			<table id="productTable" class="input">
				...
				<tr id="productTitle" class="title[#if !coupon.products?has_content] hidden[/#if]">
					<th>
						&nbsp;
					</th>
					<td width="712">
