	...
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="picture" class="text" maxlength="200" title="${message("admin.product.imageTitle")}" />
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="mpicture" class="text" maxlength="200" title="${message("admin.product.imageTitle")}" />
