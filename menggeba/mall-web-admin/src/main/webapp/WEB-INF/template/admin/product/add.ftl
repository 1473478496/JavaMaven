...
<body>
	...
	<form id="inputForm" action="save.jhtml?suit=false" method="post" enctype="multipart/form-data">
		<ul id="tab" class="tab">
			<li>
		...
		<!-- 是否纯积分商品  add by songwt 20151030 -->
			<tr>
				...
				<td>
					<input type="checkbox" id="isIntegral"  name="isIntegral" value="true" />${message("Product.isIntegral")}
			...
			<tr>
				...
				<td>
					<input type="text" name="pricePoint" class="text" maxlength="16" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="weight" class="text" maxlength="9" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="len" class="text" maxlength="9" title="" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="width" class="text" maxlength="9" title="" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="height" class="text" maxlength="9" title="" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<label>
						<input type="checkbox" name="isNewFirst" value="true" />${message("Product.isNewFirst")}
