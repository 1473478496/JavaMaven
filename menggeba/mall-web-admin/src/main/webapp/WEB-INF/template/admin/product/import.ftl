...
<body>
	...
	<form id="uploadFileForm" >
		...
		<table class="input">
			     ...
			     <tr>
				    <th>1 &raquo; 商品数据模板下载</th>
				    <td>
				    <input type="text"  style="width:100px;border:none;color:#FF0000" 
						name="exportResult" id="exportResult" readonly="true"/>
				    
				    <input type="button" id="exportBtn"  name="exportBtn" class="button" value="下载" /></td>
				...
				<tr>
				    ...
				    <th>2 &raquo;商 品 数 据   导  入</th>
					<td><input type="file" id="uploadFile" name="uploadFile" ><span style="color:red;">*</span>
					<input type="button" id="importBtn"  name="importBtn" class="button" value="${message("admin.product.import")}" />
