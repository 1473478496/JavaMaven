...
<title>${message("admin.promotion.edit")} - Powered By www.mgb.cn</title>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<div class="tabContent">
			<table class="input">
				...
				<tr>
					...
					<td colspan="2">
						<select id="category" name="category" >
							...
							<option value="others" [#if promotion.category == "others"]selected="selected"[/#if]>其它活动</option>
							<option value="secKill" [#if promotion.category == "secKill"]selected="selected"[/#if]>秒杀</option>
							<option value="dailySpecial" [#if promotion.category == "dailySpecial"]selected="selected"[/#if]>天天特价</option>
							<option value="free" [#if promotion.category == "free"]selected="selected"[/#if]>免单</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td colspan="2">
						<select id="status" name="status" >
							<option value="">${message("admin.common.choose")}</option>
							<option value="0" [#if promotion.status == false ]selected="selected"[/#if]>未启用</option>
							<option value="1" [#if promotion.status == true ]selected="selected"[/#if]>启用</option>
						</select>
					</td>
				</tr>
				...
				<tr class="memberRank" style="display: none" >
					<th>
				...
				<tr class="productCategory" style="display: none" >
					<th>
				...
				<tr class="brand" style="display: none" >
					<th>
			...
			<table id="productTable" class="input"  style="display: none;">
				<tr>
					<th>
				...
				[#list promotion.products as product]
					<tr class="productTr">
						...
						<td>
							<a href="${toView}${product.path}" target="_blank">[${message("admin.common.view")}]</a>
							<a href="javascript:;" class="deleteProduct">[${message("admin.common.delete")}]</a>
						</td>
					</tr>
				[/#list]
			</table>
			<table id="giftTable" class="input"  style="display: none;">
				<tr>
					<th>
				...
				[#list promotion.giftItems as giftItem]
					<tr class="giftTr">
						...
						<td>
							<a href="${toView}${giftItem.gift.path}" target="_blank">[${message("admin.common.view")}]</a>
							<a href="javascript:;" class="deleteGift">[${message("admin.common.delete")}]</a>
						</td>
					</tr>
				[/#list]
