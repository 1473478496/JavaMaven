			...
			<tr>
				...
				<td>
					[#if productCategory.picture??]
						<a href="${productCategory.picture }" target="_black">查看图片</a>
					[#else]
					-
					[/#if]
				</td>
				<td>
					[#if productCategory.mpicture??]
						<a href="${productCategory.mpicture }" target="_black">查看图片</a>
					[#else]
					-
					[/#if]
				</td>
				...
				<td>
					<a href="${toView}${productCategory.path}" target="_blank">[${message("admin.common.view")}]</a>
