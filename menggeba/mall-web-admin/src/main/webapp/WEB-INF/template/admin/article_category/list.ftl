...
<title>${message("admin.articleCategory.list")} - Powered By www.mgb.cn</title>
...
<body>
	...
	<table id="listTable" class="list">
		<tr>
			...
			<th>
				<span>${message("ArticleCategory.navigation")}</span>
			</th>
			...
			<tr>
				...
				<td>
					[#list navigations as navigation]
						[#if articleCategory.navigationId == navigation.id] ${navigation.name}[/#if]
					[/#list]
				</td>
				...
				<td>
					<a href="${toView}${articleCategory.path}" target="_blank">[${message("admin.common.view")}]</a>
