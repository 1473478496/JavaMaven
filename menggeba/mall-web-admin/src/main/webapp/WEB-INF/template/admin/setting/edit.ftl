...
<title>${message("admin.setting.edit")} - Powered By www.mgb.cn</title>
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				<th>
					${message("Setting.isDuplicateMobile")}:
				</th>
				<td>
					<input type="checkbox" name="_isDuplicateMobile" value="true"[#if setting.isDuplicateMobile] checked="checked"[/#if] />
					<input type="hidden" name="_isDuplicateMobile" value="false" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				<th>
					${message("Setting.isMobileLogin")}:
				</th>
				<td>
					<input type="checkbox" name="isMobileLogin" value="true"[#if setting.isMobileLogin] checked="checked"[/#if] />
					<input type="hidden" name="_isMobileLogin" value="false" />
				</td>
			</tr>
			<tr>
				<th>
