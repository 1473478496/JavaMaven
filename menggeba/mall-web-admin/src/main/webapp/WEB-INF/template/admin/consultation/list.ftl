		...
		<div class="bar">
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					...
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;"[#if page.searchProperty == "member_username"] class="current"[/#if] val="member_username">会员</a>
						</li>
					</ul>
					[#--
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;"[#if page.searchProperty == "memberId"] class="current"[/#if] val="memberId">会员名ID</a>
						</li>
					</ul>
					--]
				</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as consultation]
				<tr>
					...
					<td>
						<a href="${toView}${consultation.product.path}" title="${consultation.product.name}" target="_blank">${abbreviate(consultation.product.name, 50, "...")}</a>
					</td>
					<td>
					...
					<td>
						...
						<a href="${toView}${consultation.path}" target="_blank">[${message("admin.common.view")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
