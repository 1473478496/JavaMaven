...
<title>首页猜你喜欢编辑 - Powered By www.mgb.cn</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 首页猜你喜欢编辑
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		<input type="hidden" name="id" value="${guessYouLike.id}" />
		<div class="tabContent">
			<table id="productTable" class="input">
				<tr>
					...
					<td colspan="3">
						<input type="text" disabled="disabled" id="productSelect" name="productSelect" class="text" maxlength="200" value="${guessYouLike.product.fullName}" title="${message("admin.promotion.productSelectTitle")}" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select name="guessType">
							...
							<option value="homeType" [#if guessYouLike.guessType == "homeType"]selected[/#if]>首页</option>
							<option value="cartType" [#if guessYouLike.guessType == "cartTypeType"]selected[/#if]>购物车</option>
							<option value="detailType" [#if guessYouLike.guessType == "detailType"]selected[/#if]>详情</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td colspan="2">
						<input type="text" id="sort" name="sort" class="text" maxlength="9" value="${guessYouLike.sort }" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td colspan="2">
						<input type="text" id="description" name="description" class="text" maxlength="12" value="${guessYouLike.description }" />
					</td>
				</tr>
			</table>
		</div>
