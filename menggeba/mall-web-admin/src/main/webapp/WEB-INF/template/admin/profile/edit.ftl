...
<title>${message("admin.profile.edit")} - Powered By www.mgb.cn</title>
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post" autocomplete="off">
		<table class="input">
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input style="display:none" type="password"  class="text" maxlength="20" placeholder="请输入当前密码" autocomplete="off" />
					<input type="password" name="currentPassword" class="text" maxlength="20" placeholder="请输入当前密码" autocomplete="off" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="password" id="password" name="password" class="text" maxlength="20" placeholder="请输入新密码" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="password" name="rePassword" class="text" maxlength="20" placeholder="请再次输入新密码"/>
				</td>
			</tr>
			<tr>
				<th>
