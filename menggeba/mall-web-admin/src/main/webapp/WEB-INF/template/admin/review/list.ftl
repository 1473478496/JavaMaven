...
<title>${message("admin.review.list")} - Powered By www.mgb.cn</title>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as review]
				<tr>
					...
					<td>
						<a href="${toView}${review.product.path}" title="${review.product.name}" target="_blank">${abbreviate(review.product.name, 50, "...")}</a>
					</td>
					<td>
						${review.score}
					</td>
					...
					<td>
						...
						<a href="${toView}${review.path}" target="_blank">[${message("admin.common.view")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
