...
<title>${message("admin.role.edit")} - Powered By www.mgb.cn</title>
		...
		<table class="input">
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:productCateIndex"[#if role.authorities?seq_contains("admin:productCateIndex")] checked="checked"[/#if] />${message("admin.role.productCateIndex")}
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:changes"[#if role.authorities?seq_contains("admin:changes")] checked="checked"[/#if] />${message("admin.role.changes")}
						</label>
						<label>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:memberBirthdayRights"[#if role.authorities?seq_contains("admin:memberBirthdayRights")] checked="checked"[/#if] />${message("admin.role.memberBirthdayRights")}
						</label>
						<label>
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:signInRule"[#if role.authorities?seq_contains("admin:signInRule")] checked="checked"[/#if] />${message("admin.role.signInRule")}
						</label>
					</span>
				</td>
			</tr>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:onSale"[#if role.authorities?seq_contains("admin:onSale")] checked="checked"[/#if] />${message("admin.role.dailySpecial")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:secKill"[#if role.authorities?seq_contains("admin:secKill")] checked="checked"[/#if] />${message("admin.main.secKill")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:poster"[#if role.authorities?seq_contains("admin:poster")] checked="checked"[/#if] />${message("admin.main.poster")}
						</label>
					</span>
				</td>
			</tr>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:shippingCalculate"[#if role.authorities?seq_contains("admin:shippingCalculate")] checked="checked"[/#if] />运费维护
						</label>
						<label>
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:irule"[#if role.authorities?seq_contains("admin:irule")] checked="checked"[/#if] />${message("admin.role.irule")}
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:rights"[#if role.authorities?seq_contains("admin:rights")] checked="checked"[/#if] />权益管理
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:rProduct"[#if role.authorities?seq_contains("admin:rProduct")] checked="checked"[/#if] />权益商品
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:rOrder"[#if role.authorities?seq_contains("admin:rOrder")] checked="checked"[/#if] />权益订单
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:rBrand"[#if role.authorities?seq_contains("admin:rBrand")] checked="checked"[/#if] />权益品牌
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:rCategory"[#if role.authorities?seq_contains("admin:rCategory")] checked="checked"[/#if] />权益分类
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:rTrade"[#if role.authorities?seq_contains("admin:rTrade")] checked="checked"[/#if] />权益分类
						</label>
