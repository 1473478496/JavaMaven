...
<title>${message("admin.dailySpecial.add")} - Powered By www.mgb.cn</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.dailySpecial.add")}
	</div>
		...
		<div class="tabContent">
			...
			<table class="input">
				<tr>
					...
					<td><select id="promotionId" name="promotionId">
						...
						[#list promotions as promotion]
							<option value="${promotion.id}" id="optionId${promotion.id}">
				...
				<tr>
					...
					<td colspan="2">
						<input type="text" name="promotionPricePoint" class="text" maxlength="12" />
					</td>
				</tr>
				<tr>
					<th>
				...
				<tr>
					...
					<td colspan="2">
						<label>
							<input type="checkbox" id="isStick" name="isStick" value="true" />${message("admin.dailySpecial.stick") }
						</label>
					</td>
				</tr>
				<tr id="stickImage" class="hidden">
					...
					<td colspan="2">
						<span class="fieldSet">
							<input type="text" name="stickImage" class="text" disabled="disabled" maxlength="200" title="${message("admin.dailySpecial.imageTitle")}" />
