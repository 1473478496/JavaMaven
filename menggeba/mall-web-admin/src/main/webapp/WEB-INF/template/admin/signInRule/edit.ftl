...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		<input type="hidden" name="id" value="${signInRule.id}" />
		<table class="input tabContent">
				...
				<td>
					<select name="signRule">
						[#list RuleCategorys as RuleCategory]
							<option name="signRule" value="${RuleCategory}"[#if RuleCategory == signInRule.signRule] selected="selected"[/#if]>${RuleCategory}</option>
						[/#list]
					</select>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" name="gift" class="text" value="${signInRule.gift}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="remark" class="text" value="${signInRule.remark}" maxlength="200" />
				</td>
			</tr>
		</table>
		<table class="input">
