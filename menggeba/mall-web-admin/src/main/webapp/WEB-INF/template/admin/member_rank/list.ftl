...
<title>${message("admin.memberRank.list")} - Powered By www.mgb.cn</title>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as memberRank]
				<tr>
					...
					<td>
					[#list memberRankRigths as mrr]
						[#if memberRank.id == mrr.memberRank.id && mrr.rightsName == 'priceConcessions']${mrr.rightsValue}[/#if]
					[/#list]
					</td>
					<td>
						${(memberRank.amount)!"-"}
