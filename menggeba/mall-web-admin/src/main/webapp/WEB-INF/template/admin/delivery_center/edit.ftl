...
<title>${message("admin.deliveryCenter.edit")} - Powered By www.mgb.cn</title>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td >
					<input type="text" name="zipCode" class="text" value="${deliveryCenter.zipCode}" maxlength="6" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="phone" name="phone" class="text" value="${deliveryCenter.phone}" maxlength="13" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="mobile" name="mobile" class="text" value="${deliveryCenter.mobile}" maxlength="11" />
				</td>
			</tr>
			<tr>
				<th>
