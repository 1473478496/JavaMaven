...
<title>${message("admin.promotion.add")} - Powered By www.mgb.cn</title>
	...
	<form id="inputForm" action="save.jhtml" method="post">
				...
				<tr>
					...
					<td colspan="2">
						<select id="category" name="category" >
							...
							<option value="others">其它活动</option>
							<option value="secKill">秒杀</option>
							<option value="dailySpecial">天天特价</option>
		...
		<table class="input">
			<tr>
				...
				<td>
					<input type="submit" class="button" value="${message("admin.common.submit")}" onclick="date();"/>
