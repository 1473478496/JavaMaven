	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="advertised">宣传图</a>
				</th>
				<th>
				...
				[#--<th>
					<a href="javascript:;" class="sort" name="remark">介绍</a>
				</th>--]
				<th>
			...
			[#list page.content as brand]
				<tr>
					...
					<td>
						[#if brand.advertised??]
							<a href="${brand.advertised}" target="_blank">${message("admin.common.view")}</a>
						[#else]
							-
						[/#if]
					</td>
