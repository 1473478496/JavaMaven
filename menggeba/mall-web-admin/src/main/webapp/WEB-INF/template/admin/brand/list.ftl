	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="picture">${message("Brand.picture")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="url">${message("Brand.url")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="wurl">${message("Brand.wurl")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="isPopularity">${message("Brand.isPopularity")}</a>
				</th>
				<th>
			...
			[#list page.content as brand]
				<tr>
					...
					<td>
						[#if brand.type == "image" && brand.logo != ""]
							<a href="${brand.logo}" target="_blank">${message("admin.common.view")}</a>
						[#else]
							<span class="grey">${message("admin.common.view")}</span>
						[/#if]
					</td>
					<td>
						[#if brand.type == "image" && brand.picture != ""]
							<a href="${brand.picture}" target="_blank">${message("admin.common.view")}</a>
						[#else]
							<span class="grey">${message("admin.common.view")}</span>
						[/#if]
					</td>
					...
					<td>
						[#if brand.wurl==null]
							-
						[#else]
							<a href="${brand.wurl}" target="_blank">${brand.wurl}</a>
						[/#if]
					</td>
					<td>
						[#if brand.isPopularity]
							是
						[#else]
							否
						[/#if]
					...
					<td>
						...
						<!--<a href="${toView}${brand.path}" target="_blank">[${message("admin.common.view")}]</a>-->
					</td>
				</tr>
			[/#list]
		</table>
