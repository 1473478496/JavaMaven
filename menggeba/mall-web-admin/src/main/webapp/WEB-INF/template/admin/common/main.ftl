...
<body>
	...
	<table class="main">
		<tr>
			<th class="logo">
				<a href="main.jhtml">
					<img src="${setting.logo}" alt="www.mgb.cn" />
				</a>
			</th>
			<th>
				<div id="nav" class="nav">
					<ul>
						[#list ["admin:product", "admin:productCategory", "admin:parameterGroup", "admin:attribute", "admin:specification", "admin:brand", "admin:productNotify", "admin:productCateIndex", "admin:guessYouLike"] as permission]
							...
							[/@shiro.hasPermission]
						[/#list]
						[#list ["admin:order", "admin:payment", "admin:refunds", "admin:shipping", "admin:returns","admin:changes" ,"admin:deliveryCenter", "admin:deliveryTemplate"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
						...
						[#list ["admin:navigation", "admin:article", "admin:articleCategory", "admin:tag", "admin:friendLink", "admin:adPosition", "admin:ad", "admin:template", "admin:cache", "admin:static", "admin:index"] as permission]
							...
							[/@shiro.hasPermission]
						[/#list]
						[#list ["admin:promotion", "admin:coupon", "admin:seo", "admin:sitemap", "admin:onSale", "admin:group_management", "admin:booking"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
						...
						[#list ["admin:statistics", "admin:sales", "admin:salesRanking", "admin:purchaseRanking", "admin:deposit"] as permission]
							...
							[/@shiro.hasPermission]
						[/#list]
						[#list ["admin:setting", "admin:area", "admin:paymentMethod", "admin:shippingMethod","admin:shippingCalculate", "admin:deliveryCorp", "admin:paymentPlugin", "admin:storagePlugin", "admin:admin", "admin:role", "admin:message", "admin:log", "admin:irule"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
							...
							[/@shiro.hasPermission]
						[/#list]
						[#list ["admin:rights", "admin:rProduct", "admin:rOrder","admin:rBrand","admin:rCategory","admin:rTrade"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
									<a href="#rights">权益</a>
								</li>
							...
							[/@shiro.hasPermission]
						[/#list]
						[#list ["admin:tradeAudit", "admin:tradeShopManager"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
									<a href="#merchant">商户</a>
								</li>
								[#break /]
							[/@shiro.hasPermission]
						[/#list]
						<li>
							<a href="${toView}/" target="_blank">${message("admin.main.home")}</a>
						</li>
					</ul>
				</div>
				<div class="link">
				<!--
					<a href="http://www.mgb.cn" target="_blank">${message("admin.main.official")}</a>|
					<a href="http://bbs.www.mgb.cn" target="_blank">${message("admin.main.bbs")}</a>|
					<a href="http://www.mgb.cn/about.html" target="_blank">${message("admin.main.about")}</a>
					-->
				</div>
		...
		<tr>
			<td id="menu" class="menu">
				<dl id="product" class="default">
					...
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:productCateIndex"]
						<dd>
							<a href="../product_cate_index/list.jhtml" target="iframe">${message("admin.main.productCateIndex")}</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:guessYouLike"]
						<dd>
							<a href="../guess_you_like/list.jhtml" target="iframe">${message("admin.main.guessYouLike")}</a>
						</dd>
					[/@shiro.hasPermission]
				</dl>
				<dl id="order">
					...
					[@shiro.hasPermission name="admin:changes"]
						<dd>
							<a href="../changes/list.jhtml" target="iframe">${message("admin.main.change")}</a>
						</dd>
					[/@shiro.hasPermission]
				...
				<dl id="member">
					...
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:memberBirthdayRights"]
						<dd>
							<a href="../member_bir_rights/list.jhtml" target="iframe">${message("admin.main.memberBirthdayRights")}</a>
						</dd>
					[/@shiro.hasPermission]
					[#--
					...
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:signInRule"]
						<dd>
							<a href="../signInRule/list.jhtml" target="iframe">${message("admin.main.signInRule")}</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:busniesscooper"]
						<dd>
							<a href="../busniesscooper/list.jhtml" target="iframe">合作商户</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:borderMan"]
						<dd>
							<a href="../border/list.jhtml" target="iframe">边民审核</a>
						</dd>
					[/@shiro.hasPermission]
				...
				<dl id="content">
					...
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:graphic"]
						<dd>
							<a href="../graphic/list.jhtml" target="iframe">${message("admin.main.graphic")}</a>
						</dd>
					[/@shiro.hasPermission]
				</dl>
				<dl id="marketing">
					...
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:onSale"]
						<dd>
							<a href="../daily_special/list.jhtml" target="iframe">${message("admin.main.dailySpecial")}</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:secKill"]
						<dd>
							<a href="../secKill/list.jhtml" target="iframe">${message("admin.main.secKill")}</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:poster"]
						<dd>
							<a href="../poster/list.jhtml" target="iframe">${message("admin.main.poster")}</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:group_management"]
						<dd>
							<a href="../booking/list.jhtml" target="iframe">${message("admin.main.groupManagement")}</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:booking"]
						<dd>
							<a href="../booking/search.jhtml" target="iframe">${message("admin.main.booking")}</a>
						</dd>
					[/@shiro.hasPermission]
				...
				<dl id="system">
					...
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:shippingCalculate"]
						<dd>
							<a href="../shippingCalculate/list.jhtml" target="iframe">运费维护</a>
						</dd>
					[/@shiro.hasPermission]
					...
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:irule"]
						<dd>
							<a href="../irule/list.jhtml" target="iframe">${message("admin.main.irule")}</a>
						</dd>
					[/@shiro.hasPermission]
				</dl>
				<dl id="rights">
					<dt>权益管理</dt>
					[@shiro.hasPermission name="admin:rights"]
						<dd>
							<a href="../rights/list.jhtml" target="iframe">权益商品</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:rOrder"]
						<dd>
							<a href="../rights_order/list.jhtml" target="iframe">权益订单</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:rBrand"]
						<dd>
							<a href="../rights_brand/list.jhtml" target="iframe">权益品牌</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:rCategory"]
						<dd>
							<a href="../rights_category/list.jhtml" target="iframe">权益分类</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:rTrade"]
						<dd>
							<a href="../rights_trade/list.jhtml" target="iframe">权益商户</a>
						</dd>
					[/@shiro.hasPermission]
				</dl>
				<dl id="merchant">
				    <dt>商家管理</dt>
				    [@shiro.hasPermission name="admin:tradeAudit"]
						<dd>
							<a href="../tradeAudit/list.jhtml" target="iframe">商户审核</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:tradeShopManager"]
						<dd>
							<a href="../tradeShop/list.jhtml" target="iframe">店铺管理</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:tradeFee"]
						<dd>
							<a href="../tradeFee/list.jhtml" target="iframe">手续费维护</a>
						</dd>
					[/@shiro.hasPermission]
				</dl>
			</td>
