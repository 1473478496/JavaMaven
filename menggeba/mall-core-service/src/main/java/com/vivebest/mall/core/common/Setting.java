...
public class Setting implements Serializable {
	...
	/** 是否允许手机重复注册*/
	private Boolean isDuplicateMobile;
	...
	/** 注册是否需要手机验证码*/
	private Boolean isNeedPhoneRegister;

	/** 注册是否需要图片验证码 */
	private Boolean isNeedPictureRegister;
	 ...
	 * 获取是否允许手机重复注册
	 * 
	 * @return 是否允许Mobile重复注册
	 */
	@NotNull
	public Boolean getIsDuplicateMobile(){
		return isDuplicateMobile;
	}
	
	/**
	 * 设置是否允许手机重复注册
	 * 
	 * @param isDuplicateMobile
	 *            是否允许mobile重复注册
	 */
	public void setIsDuplicateMobile(Boolean isDuplicateMobile){
	...
	public Boolean getIsNeedPhoneRegister() {
		return isNeedPhoneRegister;
	}

	public void setIsNeedPhoneRegister(Boolean isNeedPhoneRegister) {
		this.isNeedPhoneRegister = isNeedPhoneRegister;
	}

	public Boolean getIsNeedPictureRegister() {
		return isNeedPictureRegister;
	}

	public void setIsNeedPictureRegister(Boolean isNeedPictureRegister) {
		this.isNeedPictureRegister = isNeedPictureRegister;
	}
