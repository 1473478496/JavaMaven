...
<%@page import="cn.sunline.core.util.SysThemesUtil,cn.sunline.core.enums.SysThemesEnum"%>
...
<head>
  ...
  <meta charset="utf-8" />
  <title><t:mutiLang langKey="亚太财险车险派修管理系统"/></title>
  ...
  <link rel="stylesheet" href="plug-in/ace/css/ace.css" class="ace-main-stylesheet" id="main-ace-style" />
      <link href="plug-in/login/resources/css/axure_rp_page.css" type="text/css" rel="stylesheet"/>
    <link href="plug-in/login/data/styles.css" type="text/css" rel="stylesheet"/>
    <link href="plug-in/login/files/login/styles.css" type="text/css" rel="stylesheet"/>

  <style type="text/css">
	.yy-login {
  background: #394557 url('plug-in/login/images/login/u0.jpg') no-repeat;
...
.yy-login .widget-box .toolbar {
  border-top-width: 1px;
}
.yy-login .widget-box.login-box {
  background-color: #BCC6CF;
  background-color: rgba(100, 110, 120, 0.4);
}
.yy-login .widget-box.signup-box {
  background-color: #C1CEC4;
  background-color: rgba(110, 120, 100, 0.4);
}
.yy-login .widget-box.forgot-box {
...
<body class="login-layout yy-login"  style="position: relative;top:100px;left:-100px">
        ...
        <div class="login-container">
          <div class="center">
            <h1 id="id-text2" class="grey">
              <i class="ace-icon fa fa-leaf green"></i> 亚太财险车险派修管理系统
            </h1>
                ...
                <div class="widget-main" >
                 <div class="alert alert-warning alert-dismissible" role="alert" id="errMsgContiner">
                  ...
                  <div class="space-6"></div>
                      ...
                      <div class="clearfix" >
                        <label class="inline" >
                          <input type="checkbox" class="ace" id="on_off" style="display:none"   name="remember" value="yes"/>
