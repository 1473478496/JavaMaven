package cn.sunline.core.common.service.impl;
...
import cn.sunline.tag.vo.easyui.Autocomplete;
...
public class CommonServiceImpl implements CommonService {
	 ...
	 * @return
	 */
	public <T> List<T> findByQueryString(String hql,int page,int rows) {
		return commonDao.findByQueryString(hql,page,rows);
	}
