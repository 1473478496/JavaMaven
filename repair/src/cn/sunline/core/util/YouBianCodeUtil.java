...
//			 cn.sunline.core.util.LogUtil.info(after_code);
//			 cn.sunline.core.util.LogUtil.info(after_code_zimu);
//			 cn.sunline.core.util.LogUtil.info(after_code_num);
...
//			return parentCode + getNextYouBianCode(localCode);
	...
	public static void main(String[] args) {
		// cn.sunline.core.util.LogUtil.info(getNextZiMu('C'));
		// cn.sunline.core.util.LogUtil.info(getNextNum(8));
		cn.sunline.core.util.LogUtil.info(getSubYouBianCode("C99A01","B03"));
//		cn.sunline.core.util.LogUtil.info(cutYouBianCode("C99A01B01")[2]);
	}
}
