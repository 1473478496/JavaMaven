...
import cn.sunline.core.def.ConstantsDefs;
...
public class JeecgSqlUtil {
	...
	private static String getFlieTxt(String fileUrl) {
		cn.sunline.core.util.LogUtil.info("---------------------------------------sql 路径 :"+fileUrl);
		String sql = null;
		try {
	...
	public static String getMethodSqlLogic(String methodUrl){
		...
		cn.sunline.core.util.LogUtil.info(sqlurl);
...
//		cn.sunline.core.util.LogUtil.info(projectPath);
//		String projectPath =  request.getSession().getServletContext().getRealPath("/");
	...
	public static String getAppPath(Class cls) {
		...
		cn.sunline.core.util.LogUtil.info("realPath----->"+realPath);
		return realPath;
	}
	...
	public static void main(String[] args) {
		//cn.sunline.core.util.LogUtil.info(getAppPath(JeecgSqlUtil.class));
		cn.sunline.core.util.LogUtil.info(getCountSqlBySql("SELECT * 	from JEECG_DICT_PARAM WHERE 1=1"));
	}
