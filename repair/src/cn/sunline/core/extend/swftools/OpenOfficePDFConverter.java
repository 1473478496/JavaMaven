package cn.sunline.core.extend.swftools;
...
//				cn.sunline.core.util.LogUtil.info("odt文件已存在！");
//				inputFile = odtFile;
//			} else {
//				try {
...
//					cn.sunline.core.util.LogUtil.info("Odt文档不存在！");
//					e.printStackTrace();
//				}
//			}
//
//		}
		...
		//pdfFile = pdfFile.replaceAll(" ", "").replaceAll("　", "");
		 cn.sunline.core.util.LogUtil.info("进行文档转换转换:" + inputFile + " --> " + pdfFile);
		...
		try {
			...
			cn.sunline.core.util.LogUtil.info(e.getMessage());
		}
		
		stopService();
	    cn.sunline.core.util.LogUtil.info("进行文档转换转换---- 结束----");
	}
	...
	public static void startService() {
		...
		try {
			...
			cn.sunline.core.util.LogUtil.info("office转换服务启动成功!");
		} catch (Exception ce) {
			cn.sunline.core.util.LogUtil.info("office转换服务启动失败!详细信息:" + ce);
		}
	}

	public static void stopService() {
		cn.sunline.core.util.LogUtil.info("关闭office转换服务....");
		if (officeManager != null) {
			officeManager.stop();
		}
		cn.sunline.core.util.LogUtil.info("关闭office转换成功!");
	}
}
