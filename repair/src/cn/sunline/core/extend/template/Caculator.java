package cn.sunline.core.extend.template;
...
//					{
//						cn.sunline.core.util.LogUtil.info(tt);
//					}
    ...
    public String transInfixToPosfix(String in)
    {
        ...
        for(int i=0;i<cin.length;i++)
        {
            ...
            case ')':
                ...
                if(!meetClose)
                {
                	cn.sunline.core.util.LogUtil.info(in);
            ...
            default:
                ...
                try {
						...
						e.printStackTrace();
						cn.sunline.core.util.LogUtil.info("cal数字生成错误！！");
					}
...
//        cn.sunline.core.util.LogUtil.info(calc.transInfixToPosfix("1+2*3+7.5-(4/2+8)/5"));
//        cn.sunline.core.util.LogUtil.info("value is:"+calc.calc());
        
//        cn.sunline.core.util.LogUtil.info(calc.transInfixToPosfix("110815.00047*2"));
//        cn.sunline.core.util.LogUtil.info("value is:"+calc.calc());
//        cn.sunline.core.util.LogUtil.info(calc.transInfixToPosfix("110815.125047*2"));
//        cn.sunline.core.util.LogUtil.info("value is:"+calc.calc());
        
//        cn.sunline.core.util.LogUtil.info(calc.transInfixToPosfix("((110815.0347)*2+10)/0"));
//        cn.sunline.core.util.LogUtil.info("value is:"+calc.calc());
        
        
//        cn.sunline.core.util.LogUtil.info(calc.transInfixToPosfix("0.02"));
//        cn.sunline.core.util.LogUtil.info("value is:"+calc.calc());
//        cn.sunline.core.util.LogUtil.info(calc.transInfixToPosfix("0.0"));
//        cn.sunline.core.util.LogUtil.info("value is:"+calc.calc());
       
       cn.sunline.core.util.LogUtil.info(calc.transInfixToPosfix("1.3E7+0.5"));   
       cn.sunline.core.util.LogUtil.info("value is:"+calc.calc());
        Double dd=Double.parseDouble("1.35378957E7");
        
        cn.sunline.core.util.LogUtil.info(Caculator.getDtoI(dd));
        
        cn.sunline.core.util.LogUtil.info(dd);
