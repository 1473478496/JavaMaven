...
import cn.sunline.web.system.pojo.base.TSRoleOrg;
...
public class RoleController extends BaseController {
	...
	public AjaxJson delRole(TSRole role, HttpServletRequest request) {
		...
		if (count == 0) {
           ...
           // systemService.executeSql("delete from t_s_role where id=?", role.getId()); // 删除 角色-机构 关系信息
...
//    }
	...
	public String exportXls(TSRole tsRole,HttpServletRequest request,HttpServletResponse response
		...
		CriteriaQuery cq = new CriteriaQuery(TSRole.class, dataGrid);
		cn.sunline.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tsRole, request.getParameterMap());
