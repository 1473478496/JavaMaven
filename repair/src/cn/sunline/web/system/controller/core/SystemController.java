...
//import cn.sunline.web.system.pojo.base.TSDocument;
...
import cn.sunline.core.common.dao.jdbc.JdbcDao;
...
import cn.sunline.core.extend.hqlsearch.parse.ObjectParseUtil;
import cn.sunline.core.extend.hqlsearch.parse.PageValueConvertRuleEnum;
import cn.sunline.core.extend.hqlsearch.parse.vo.HqlRuleEnum;
import cn.sunline.core.util.DateUtils;
import cn.sunline.core.util.JSONHelper;
import cn.sunline.core.util.ListUtils;
import cn.sunline.core.util.MutiLangSqlCriteriaUtil;
import cn.sunline.core.util.MutiLangUtil;
import cn.sunline.core.util.MyClassLoader;
import cn.sunline.core.util.ResourceUtil;
import cn.sunline.core.util.SetListSort;
import cn.sunline.core.util.StringUtil;
import cn.sunline.core.util.YouBianCodeUtil;
...
import cn.sunline.web.system.manager.ClientSort;
import cn.sunline.web.system.pojo.base.Client;
import cn.sunline.web.system.pojo.base.DataLogDiff;
...
import cn.sunline.web.system.pojo.base.TSVersion;
...
//	}
    ...
    public void dataLogDatagrid(TSDatalogEntity datalogEntity,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid){
		...
		//查询条件组装器
		cn.sunline.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, datalogEntity, request.getParameterMap());
		cq.add();
		this.systemService.getDataGridReturn(cq, true);
		TagUtil.datagrid(response, dataGrid);
    }
