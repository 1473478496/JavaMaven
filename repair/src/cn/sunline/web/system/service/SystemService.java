...
public interface SystemService extends CommonService{
	 ...
	 * @param id
	 */
	public void flushRoleFunciton(String departId,String id, TSFunction newFunciton);
	...
	public  Set<String> getOperationCodesByUserIdAndDataId(String departId,String userId,String functionId);
