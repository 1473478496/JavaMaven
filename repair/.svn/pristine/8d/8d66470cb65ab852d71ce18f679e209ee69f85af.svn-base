...
<t:datagrid name="userList" title="common.operation" actionUrl="userController.do?datagrid" 
	...
	<t:dgCol title="归属机构代码" field="id" hidden="true"></t:dgCol>
	...
	<t:dgCol title="common.department" sortable="false" field="departName" query="false"></t:dgCol>
	<t:dgCol title="组织机构Id" sortable="false"  hidden="true" field="departid" ></t:dgCol>
