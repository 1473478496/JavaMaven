...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="currentDepartList"  fitColumns="false" title="组织机构列表" actionUrl="departController.do?departListDatagrid" idField="id" fit="true" queryMode="group">
   <t:dgCol title="归属机构代码" field="id"   query="true"></t:dgCol>
   <t:dgCol title="机构名称" field="departname" query="true"></t:dgCol>
