...
public class DataGridColumnTag extends TagSupport {
	...
	protected boolean sortable=false;//默认不排序呢
	...
	protected boolean datebox=false;//日期格式
	protected boolean datetimebox=false;//日期加时间
	...
	public int doEndTag() throws JspTagException {
		...
		parent.setColumn(title,field,width,showLen,rowspan,colspan,align,sortable,checkbox,formatter,formatterjs,hidden,replace,treefield,image,imageSize,query,url,funname,arg,queryMode, dictionary,popup,frozenColumn,extend,style,downloadName,autocomplete,extendParams,editor,defaultVal,datebox,datetimebox);
		return EVAL_PAGE;
	}
...
//	public boolean isDatetimebox() {
//		return datetimebox;
//	}

	public void setDatetimebox(boolean datetimebox) {
