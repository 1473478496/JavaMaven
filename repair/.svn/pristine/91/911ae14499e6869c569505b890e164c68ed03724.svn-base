...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="lableList1" title="品牌型号信息查询" checkbox="true" actionUrl="lableController.do?datagrid" 
	fitColumns="false"  idField="brandCode" queryMode="group" fit="true">
   <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
   <t:dgCol title="品牌名称" field="moedlBrand" query="true"  width="530"></t:dgCol>
   <t:dgCol title="品牌编码" field="brandCode" query="true" width="530"></t:dgCol>
