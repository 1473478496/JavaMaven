...
function typeGridTree_AddType() {
	...
	add("参数值新增("+node.text+")", "systemController.do?addorupdateType&typegroupid="+groupid, treeCtrlId);
}
...
<div id="main_typegroup_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="typeGridTree" title="common.data.dictionary" queryMode="group" actionUrl="systemController.do?typeGroupGrid" idField="id" treegrid="false" pagination="false"  sortOrder="desc" sortName="id" onLoadSuccess="loadSuccess">
