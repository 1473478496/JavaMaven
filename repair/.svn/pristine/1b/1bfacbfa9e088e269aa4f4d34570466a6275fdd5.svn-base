 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tSSmsTemplateController.do?doUpdate" tiptype="1">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<td class="value">
					     <%-- 	<t:dictSelect field="vehicleType" type="list"
							  typeGroupCode="car_Type" defaultVal="${tSSmsTemplatePage.vehicleType}"  hasLabel="false"  title="是否是三者车"></t:dictSelect> --%>
							<span class="Validform_checktip"><input type="radio" <c:if test="${tSSmsTemplatePage.vehicleType=='01'}">checked="checked" </c:if> name="vehicleType"  value="01"></span>适用于三者
							<span class="Validform_checktip"><input type="radio"<c:if test="${tSSmsTemplatePage.vehicleType=='00'}">checked="checked" </c:if> name="vehicleType" value="00"></span>适用于标的
							<span class="Validform_checktip"></span>
